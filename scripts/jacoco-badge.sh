...
# No external services — output is a self-contained file committed to the repo.
#
# Usage: scripts/jacoco-badge.sh [csv_path] [svg_path]
...
# JaCoCo CSV columns:
# GROUP,PACKAGE,CLASS,INSTRUCTION_MISSED(4),INSTRUCTION_COVERED(5),...
