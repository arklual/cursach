...
- Name: modals.spec.ts >> Workflow editor — modal toggles >> "Результаты A/B" opens experiment modal
- Location: e2e/modals.spec.ts:41:7
...
Call log:
  - waiting for getByRole('button', { name: 'Результаты A/B' })
