...
- Name: workflows.spec.ts >> Workflow editor — interactions >> Simulate 500 users → execution log получает строки
- Location: e2e/workflows.spec.ts:213:7
...
Call log:
  - waiting for getByRole('button', { name: /Симуляция \(500\)/i })
