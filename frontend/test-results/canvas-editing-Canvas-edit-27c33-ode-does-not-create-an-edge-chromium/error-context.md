...
- Name: canvas-editing.spec.ts >> Canvas editing >> dragging from any source onto a trigger node does not create an edge
- Location: e2e/canvas-editing.spec.ts:165:7
