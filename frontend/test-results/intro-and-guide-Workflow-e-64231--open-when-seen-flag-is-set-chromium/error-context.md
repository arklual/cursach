...
- Name: intro-and-guide.spec.ts >> Workflow editor — Guide modal first-visit >> Guide modal does NOT auto-open when seen flag is set
- Location: e2e/intro-and-guide.spec.ts:95:7
