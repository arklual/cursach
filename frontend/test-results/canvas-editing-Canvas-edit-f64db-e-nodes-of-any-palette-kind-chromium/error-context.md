...
- Name: canvas-editing.spec.ts >> Canvas editing >> can add multiple nodes of any palette kind
- Location: e2e/canvas-editing.spec.ts:44:7
...
Locator: locator('app-palette .palette-item').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('app-palette .palette-item').first()
