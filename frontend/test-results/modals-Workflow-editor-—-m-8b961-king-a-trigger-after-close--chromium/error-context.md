...
- Name: modals.spec.ts >> Workflow editor — modal toggles >> only one modal is rendered at a time (re-clicking a trigger after close)
- Location: e2e/modals.spec.ts:75:7
