...
- Name: intro-and-guide.spec.ts >> Workflows list — intro banner >> shows intro banner on first visit and hides it after dismiss + reload
- Location: e2e/intro-and-guide.spec.ts:21:7
