...
- Name: intro-and-guide.spec.ts >> Workflows list — intro banner >> intro banner has primary "+ Создать workflow" that navigates to editor
- Location: e2e/intro-and-guide.spec.ts:50:7
