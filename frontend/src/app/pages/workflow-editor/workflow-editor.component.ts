    ...
    <div class="app-shell">
      <header class="app-header">
        ...
        <div class="header-actions">
          ...
          <button class="icon-btn guide-btn" (click)="openModal('guide')" title="Пошаговая инструкция" aria-label="Гайд">
            <svg class="icon" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
        ...
        <div class="guide">
          ...
          <div class="guide-tips">
            ...
            <ul>
              ...
              <li>Граф сохраняется автоматически через ~1 сек после правки.</li>
...
export class WorkflowEditorComponent implements OnInit, OnDestroy {
  ...
  closeModal(key: string): void {
    ...
    if (key === 'guide' && isPlatformBrowser(this.platformId)) {
      try { localStorage.setItem(this.guideStorageKey, '1'); } catch { }
    }
  }
  ...
  private maybeShowGuide(): void {
    ...
    try { seen = localStorage.getItem(this.guideStorageKey); } catch { }
    if (seen !== '1') {
