...
describe('WorkflowApiService', () => {
    ...
    it('list() выполняет GET /workflows и возвращает массив WorkflowMeta', () => {
        const fixture: WorkflowMeta[] = [
            { id: 'wf-1', name: 'Test', description: 'd', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
        ];
    ...
    it('updateMeta() выполняет PUT /workflows/{id}', () => {
        const fixture: WorkflowMeta = { id: 'wf-1', name: 'renamed', createdAt: '', updatedAt: '' };
