...
echo "  5. Задай GitHub Secrets для basic auth на фронте:"
echo "       FRONTEND_BASIC_AUTH_USER     — логин"
echo "       FRONTEND_BASIC_AUTH_PASSWORD — пароль"
echo "     CI сгенерит bcrypt-хэш и зальёт /opt/kursach/.htpasswd при следующем деплое фронта."
