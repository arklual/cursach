...
- `docs/event_schemas.json` — спецификация событий.
- `docs/metrics.md` — агрегаты и формулы.
- `docs/storage.sql` — предложение DDL/ER.
- `docs/qa_scenarios.md` — сценарии тестирования.
- `data/simulated_events.json` — пример данных симуляции.
