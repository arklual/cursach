...
class CountryDossierPlan(objectMapper: ObjectMapper) : DemoWorkflowPlan {
    ...
    companion object {
        private val DOSSIER_JS = """
            // Inputs:
            //   inputs.country.body[0]: RESTCountries record
            //   inputs.holidays.body:   [{ date, name, localName, types }]
            //   inputs.summary.body:    Wikipedia REST summary
            // Output: CRM-ready dossier { headline, summary, keyInsights, actionItems, report, details }
