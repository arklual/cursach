...
/**
 * Pre-pulls sandbox images at startup so the very first JS/Python node run doesn't
 * have to wait for a ~50MB image download inside its timeout budget. Best-effort:
 * any failure is logged and falls back to lazy pull on first use.
 */
@Component
