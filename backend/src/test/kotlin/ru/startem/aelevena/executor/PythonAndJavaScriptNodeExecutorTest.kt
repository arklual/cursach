...
/**
 * Юнит-тесты Python/JS node executor'ов с ручным stub'ом ContainerSandboxRunner —
 * проверяем построение payload'а и пробрасывание image/timeout, не запуская docker.
 */
